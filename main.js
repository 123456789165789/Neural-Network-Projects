...
carImage.src = "SuperCar.jpg"; // Path to your car image

const carCtx = carCanvas.getContext("2d");
const networkCtx = networkCanvas.getContext("2d");

//  Set road with 2 lanes
const road = new Road(carCanvas.width / 2, carCanvas.width * 0.9, 2);
...
// Updated traffic to only use lane 0 and lane 1
const traffic = [
